...
class EmacsPlusAT32 < EmacsBase
  ...
  # Fork-only addition (not in upstream): pour the CI-built nightly
  # bottle from this fork's fixed release tag. The sha256 is updated
  # by the build-bottle workflow on each build. Workbrew on the
  # target machine blocks installing bottles from local paths/URLs,
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_tahoe: "41256a2c9262615a2415bd0e78c17142c4d373913189c4bd017a9e4a8f3cc294"
  end
  #
  # Options
  #
